...
OBJECTS += ActiveKeys/ActiveKeys.o
OBJECTS += AnalogPotRead/analogpotread.o
OBJECTS += DeviceCHAIN/DeviceCHAIN.o
OBJECTS += DeviceDCO/DeviceDCO.o
OBJECTS += DeviceVoice/DeviceVoice.o
OBJECTS += Frequencies/Frequencies.o
OBJECTS += I2CDevice/I2CDevice.o
OBJECTS += I2CHelper/I2CHelper.o
OBJECTS += InterfaceDisplay/InterfaceDisplay.o
OBJECTS += InterfaceSDCard/InterfaceSDCard.o
OBJECTS += MIDI/midi.o
OBJECTS += Performer/Performer.o
OBJECTS += QEI/QEI.o
...
INCLUDE_PATHS += -I../
INCLUDE_PATHS += -I../.
INCLUDE_PATHS += -I../ActiveKeys
INCLUDE_PATHS += -I../AnalogPotRead
INCLUDE_PATHS += -I../DeviceCHAIN
INCLUDE_PATHS += -I../DeviceDCO
INCLUDE_PATHS += -I../DeviceVoice
INCLUDE_PATHS += -I../Frequencies
INCLUDE_PATHS += -I../I2CDevice
INCLUDE_PATHS += -I../I2CHelper
INCLUDE_PATHS += -I../InterfaceDisplay
INCLUDE_PATHS += -I../InterfaceSDCard
INCLUDE_PATHS += -I../MIDI
INCLUDE_PATHS += -I../Performer
INCLUDE_PATHS += -I../QEI
INCLUDE_PATHS += -I../SDFileSystem
INCLUDE_PATHS += -I../SDFileSystem/FATFileSystem
INCLUDE_PATHS += -I../SDFileSystem/FATFileSystem/ChaN
INCLUDE_PATHS += -I../Sysex
...
C_FLAGS += -DMBED_BUILD_TIMESTAMP=1507426801.43
...
CXX_FLAGS += -DMBED_BUILD_TIMESTAMP=1507426801.43
...
ASM_FLAGS += -I.
ASM_FLAGS += -IActiveKeys
ASM_FLAGS += -IDeviceVoice
ASM_FLAGS += -II2CHelper
ASM_FLAGS += -IMIDI
ASM_FLAGS += -IPerformer
ASM_FLAGS += -IDeviceDCO
ASM_FLAGS += -II2CDevice
ASM_FLAGS += -ISDFileSystem
ASM_FLAGS += -ISDFileSystem/FATFileSystem
ASM_FLAGS += -ISDFileSystem/FATFileSystem/ChaN
ASM_FLAGS += -IFrequencies
ASM_FLAGS += -ISysex
ASM_FLAGS += -IQEI
ASM_FLAGS += -IAnalogPotRead
ASM_FLAGS += -ITextLCD
ASM_FLAGS += -IInterfaceSDCard
ASM_FLAGS += -IDeviceCHAIN
ASM_FLAGS += -IInterfaceDisplay
ASM_FLAGS += -Imbed/.
